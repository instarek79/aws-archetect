...
Write-Host "  Backend:   https://localhost:8805" -ForegroundColor White
Write-Host "  API Docs:  https://localhost:8805/docs" -ForegroundColor White
Write-Host ""
...
python -m uvicorn app.main:app --reload --host 0.0.0.0 --port 8805 --ssl-keyfile="certs/key.pem" --ssl-certfile="certs/cert.pem"
