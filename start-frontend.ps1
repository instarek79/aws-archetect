...
try {
    $response = Invoke-WebRequest -Uri "https://localhost:8805/health" -UseBasicParsing -TimeoutSec 2 -ErrorAction Stop -SkipCertificateCheck
...
Write-Host "Backend:   https://localhost:8805" -ForegroundColor Cyan
Write-Host ""
